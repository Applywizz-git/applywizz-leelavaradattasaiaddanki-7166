    ...
    <section id="contact" className="section-padding bg-card/50">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            {[
              { icon: FiPhone, label: "Phone", value: "+1(940) 843-0289", color: "from-blue-400 to-blue-600" },
              { icon: FiMail, label: "Email", value: "Leelavaradattasaiaddanki9@gmail.com", color: "from-purple-400 to-purple-600" },
              { icon: FiMapPin, label: "Location", value: "Denton, TX", color: "from-orange-400 to-orange-600" },
            ].map((item, i) => (
              <motion.div
                key={item.label}
              ...
              >
                ...
                <div className="card-3d-content min-w-0">
                  ...
                  <p className="text-[9px] sm:text-[11px] md:text-xs lg:text-sm font-heading font-black text-foreground group-hover:text-accent transition-colors break-all md:break-normal leading-tight">
                    {item.value}
                  </p>
                </div>
              </motion.div>
