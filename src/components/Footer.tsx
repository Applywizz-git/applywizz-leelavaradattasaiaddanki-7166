  ...
  return (
    <footer className="py-12 px-6 border-t border-border bg-card/30 backdrop-blur-md overflow-hidden relative">
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        >
          © {new Date().getFullYear()} — <span className="text-foreground font-black uppercase tracking-widest">LEELA VARADATTA SAI ADDANKI</span>
          <FiHeart className="text-accent animate-pulse" size={14} />
        </motion.p>
        <div className="flex gap-6">
          {[
            { icon: FiMail, href: "mailto:Leelavaradattasaiaddanki9@gmail.com", label: "Email" },
            { icon: FiLinkedin, href: "https://www.linkedin.com/in/sai-addanki-456278157/", label: "LinkedIn" },
          ].map((social, i) => (
