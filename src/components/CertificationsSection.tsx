...
import { FiAward, FiCloud, FiPieChart, FiCode, FiZap, FiServer, FiSettings, FiBriefcase, FiUsers } from "react-icons/fi";

const certifications = [
  { name: "Certified System Administrator (CSA)", provider: "ServiceNow", icon: FiSettings },
  { name: "Certified Application Developer (CAD)", provider: "ServiceNow", icon: FiCode },
  { name: "Certified Implementation Specialist - IT Data Foundations (CIS-DF)", provider: "ServiceNow", icon: FiServer },
  { name: "Certified Implementation Specialist - IT Service Management (CIS-ITSM)", provider: "ServiceNow", icon: FiBriefcase },
  { name: "Certified Implementation Specialist - Human Resources (CIS-HR)", provider: "ServiceNow", icon: FiUsers },
  { name: "Microsoft Azure Fabrics DP - 700", provider: "Microsoft", icon: FiCloud },
];
